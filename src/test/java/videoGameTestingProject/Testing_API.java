package videoGameTestingProject;
...
public class Testing_API {
	...
	@Test(priority=1)
	public void firstTestGetAllVideoGames() {
	...
	@Test(priority=2)
	public void secondTestAddAllNewVideoGames()
	{
	...
	@Test(priority=3)
	public void thirdTestGetSpecificVideoGame()
	{
		given()
		.when()
	...
	@Test(priority=4)
	public void fourthTestUpdateVideoGame()
	{
	...
	@Test(priority=5)
	public void fifthTestDeleteVideoGame()
	{
		Response res=
		given()
		.when()
